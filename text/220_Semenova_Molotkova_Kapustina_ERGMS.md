...
![Детерминистские подходы к анализу сетей\label{deterministic}](22_1.png)
...
![Классификация основных стохастических подходов к анализу динамических сетей\label{dynamic}](22_2.png)
...
![Классификация процессов формирования социальных связей\label{TiesFormation}](22_3.png)
