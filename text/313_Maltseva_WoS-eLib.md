...
: Основания, параметры и способы анализа для сравнения баз данных {#tbl:CompareParams}
...
Платформа WoS дает возможность выгрузки библиографических описаний отобранных работ в различных форматах (RIS, Excel, обычный текстовый файл - plain text) для всех зарегистрированных пользователей (чей доступ осуществляется через организационную подписку). Используемый формат представляет собой текстовый файл структурированного вида с идентифицированными полями (Рис.1). В зависимости от того собирается или нет информация о цитируемой литературе (поле “CR”), за одну итерацию можно загрузить до 500 или 1000 библиографических описаний в едином файле. Для сбора данных был написан программный код на Python, который позволял итеративно обращаться к базе и последовательно собирать файлы с описаниями. Данные собраны в мае 2022 г. 

Рис. 1. Пример библиографических описаний публикаций: 

eLibrary (XML-страница, сверху) и WoS (текстовый файл, снизу)![](https://lh7-us.googleusercontent.com/w2JPlo08sh_PW032jpUQJ2_0MKM5agpqO8RpxmKOjhYND_dqEPK53E7VZguEKxoTRHX46T0rfnc0cTsv-vJmuZSGgIsaG-7M1kD2to0X9nQ_SKuoZLRvh2yxyJPKEeotjcIGt5mawCIruvQYuJdztvd92mpkJVVe)

![](https://lh7-us.googleusercontent.com/umqrB22O6ptZVlPFIqKPWrCui-0DJS0xv2y60QeyRLbOH3VnMUryXS5WnGNkpuU4MR2D8-QH7Wa1axExEpY1lkqazIBLwUEJLcQzfkjFvbQCtVdqf7o_cy3Tos-97PKqD87HzrCh38u6Cth0ZTt98KSstZSjVIVX)
...
Рис.2. Рабочее окно программы WoS2Pajek

![](https://lh7-us.googleusercontent.com/87xBhusxEOAajI7SgqwccJglm_jwTJgI54p2pk6IWa9pbuw5cTrL6C0bKNRK1DcbZaIVRaQjm2hBk1VRnkXRTr26winLtySqFqdSX_6Uvj3Lc-04jvWzjvafp1ND6Hb-WwU5HR69_ZvstoiBqoWWjfC73irm1Wkz)
...
Таблица 5. Сходство между базами данных по числу публикаций (массив eLibrary) 
...
Таблица 6. Топ журналов из подмассива публикаций, индексируемых только в eLibrary
...
Таблица 7. Индексация журналов из массива eLibrary в различных базах
...
**Работы и авторы.** Входящая центральность в двумодальной сети **WA** показывают количество работ у авторов. Распределение этого показателя для двух массивов приведено на Рис. 4. Массивы данных значительно различаются по размеру – число публикаций в массиве eLibrary примерно в 20 раз больше числа публикаций в WoS –  поэтому различия наблюдаются и в числе авторов. Вместе с тем распределения на Рис. 4 похожи по тренду и могут следовать степенному закону, или закону Лотки, описывающему распределение продуктивности ученых. Тогда как 66% авторов в массиве eLibrary и 64% в массиве WoS имеют только одну публикацию, еще 13% и 14% - две, а по 6% - три, некоторые авторы в базах являются супер-продуктивными, имея 241, 2015 и 192 публикации в базе eLibrary и 45, 29 и 28 публикаций в базе WoS. Наиболее продуктивные авторы с наибольшим количеством работ по двум массивам приведены в Табл. 9. Четверо из выделенных топ-20 авторов присутствуют в обеих базах, однако авторы из массива eLibrary, имеющие наибольшее количество публикаций, в базе WoS имеют 1, 1 и 5 публикаций. 

Рис. 4. Распределение количества работ по авторам в двух массивах данных (логарифмическая шкала)

![](https://lh7-us.googleusercontent.com/bTFB9Js5biqffGxbK9wStjJ6CNGhXInND6_cQpnxcjowpcBns6Jl7okQ2emXQP-Tw95pRb0AwN0uiZYsWebP5qDN0n77cfB8FqcWPFiM4XaVm1D6sqKbOCa6n4o6jUK4gerXqAe2u7SLDQnYypA4V5T2FAOPKiHF)

Таблица 9. Авторы с наибольшим количеством публикаций, по двум массивам 
...
**Работы и ключевые слова.** Показатель исходящей центральности в сети **WK** показывает количество ключевых слов в работе. Для работ из массива WoS этот показатель варьируется от 1 до 40, а из массива eLibrary - от 1 до 51 (при этом в 36.7% случаев значения пропущены). Показатель входящей центральности в сети **WK** показывает частоту использования различных ключевых слов в работах. Как показывает распределение этих значений для двух массивов (Рис. 6),  77% ключевых слов в массиве eLibrary и  50.5% в WoS использованы только один раз, еще 10% и 14% соответственно - два раза, 3.6% и 7% - три раза, и т.д. В Табл. 12 приведены топ-20 слов, наиболее часто используемым в обоих массивах с долей к числу всех ключевых слов.  Повторяющиеся слова из двух массивов выделены цветом. 

Рисунок 6. Частота использования ключевых слов в работах в двух массивах данных (логарифмическая шкала)

![](https://lh7-us.googleusercontent.com/hTaFmTuM7nNJPA-drgCv2AIVseD668EJRonDnLycvt1hJuYKPxvUtmM-hVjmw4XEP5T2aj7cHLU_YTlC0wGnilA72lVam4XFu1I_hRIyJmpz5nOObSk8FP_vKbG8ujSdyNP2iYIIJQbYm2w6DuHSxxlP7E0y0Csi)

Табл.12. Топ-20 ключевых слов для обоих массивов
