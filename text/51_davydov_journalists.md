...
Количество проанализированных медиа и новостей в каждой стране представлено в @tbl:51_t1.
...
|Парагвай|4286|8|
|ВСЕГО|148,474|365|
: Количество новостных текстов и СМИ в выборке исследования по странам {#tbl:51_t1}
...
![Фрагмент массива данных, ставшего основой для несимметричной сетевой матрицы статей и их тематик](images/51_1.png){#fig:51data}

![Пример конвертации данных в формат 2-модальной сети](images/51_2.png){#fig:51data2}

## Результаты исследования 
Базовые характеристики полученных сетей. Двумодальная сеть публикаций и ролей PR состоит из 6 ролей и 67 индикаторов ролей.  Количество ролевых индикаторов по каждой роли приведено в @tbl:51_t2. Роль «сторожевого пса» содержит значительно большее количество индикаторов – 30 – по сравнению с другими ролями, куда согласно дизайну исследования включено от 5 до 10 индикаторов. Визуализация ролей и индикаторов представлена на @fig:51data3. 
...
![Визуализация сети связей между индикаторами ролей по со-встречаемости RR *(пороговые значения по весу связи 1000, 1500)*](images/51_4.png){#fig:51data4}
...
![Визуализация сети связей между индикаторами ролей по со-встречаемости RR, сжатой до уровня ролей](images/51_5.png){#fig:51data5}

Укрупненные узлы по ролям расположены на тех же местах графа, что и группы узлов на @fig:51data4.

![Визуализация сети связей между индикаторами ролей по со-встречаемости RR в виде матрицы](images/51_6.png){#fig:51data6}

![Дендрограмма по расчетам скорректированного Евклидова расстояние](images/51_7.png){#fig:51data7}

![Визуализация сети связей между индикаторами ролей по со-встречаемости RR в виде матрицы из 3 кластеров: цвет лейблов по принадлежности к кластеру (слева) и журналистской роли (справа)](images/51_8.png){#fig:51data8}
